...
public class MainMenu extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] menus = {"Tutorials","Game","Videos","Glossary"};
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_game) {
            //Handle Game fragment
            fragmentManager.beginTransaction().replace(R.id.content_frame, new GameFragment()).commit();


        } else if (id == R.id.nav_tutorials) {
            //Handle Tutorials fragment
            fragmentManager.beginTransaction().replace(R.id.content_frame, new TutorialFragment()).commit();
        } else if (id == R.id.nav_glossary) {
            //Handle Glossary fragment
            fragmentManager.beginTransaction().replace(R.id.content_frame, new GlossaryFragment()).commit();
        } else if(id == R.id.nav_videos){
            //Handle Videos fragment
            fragmentManager.beginTransaction().replace(R.id.content_frame, new VideosFragment()).commit();
        }
